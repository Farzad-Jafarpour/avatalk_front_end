...
export default function TableRenderer({ rows, headCells }) {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell
                        ...
                        padding="none"
                      >
                        {(!row.isAdmin && "No") || (row.isAdmin && "yes")}
                      </TableCell>
                      <TableCell
                        component="tr"
                        id={labelId}
                        ...
                        padding="none"
                      >
                        {(!row.isTeacher && "No") || (row.isTeacher && "yes")}
                      </TableCell>
                      <TableCell
                        component="tr"
                        id={labelId}
                        ...
                        padding="none"
                      >
                        {(!row.isStudent && "No") || (row.isStudent && "yes")}
                      </TableCell>
                    </TableRow>
                  );
                })}
